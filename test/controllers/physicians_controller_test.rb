...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post physicians_url, params: { physician: { age: @physician.age, name: @physician.name, qaulification: @physician.qaulification } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { age: @physician.age, name: @physician.name, qaulification: @physician.qaulification } }
